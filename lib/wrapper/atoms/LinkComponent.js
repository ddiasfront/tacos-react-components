...
class LinkComponent extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      routing: false,
      nextRouting: (external_params !== undefined 
        && external_params.router !== undefined 
        && external_params.router.push !== undefined  ) ? external_params.router : false
    }
  }
  ...
  render() {
    const Link = !this.props.nextRouting ? external_params.router : false;
    return (
       <StyledLink
      ...
      >
      {
        Link ? <Link to={this.props.href}>{this.props.children}</Link> : this.props.children
      }
